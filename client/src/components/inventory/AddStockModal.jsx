  ...
  return (
    <>
      ...
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4">
        ...
        >
          <h2 className="text-2xl font-bold text-gray-800 mb-6">Tambah Stok (Pemasukan)</h2>
          <form onSubmit={handleSubmit} className="space-y-4">
            {/* ... (Input fields tidak berubah) ... */}
            <div>
              <label className="block text-sm font-medium text-gray-700">Pilih Bahan <span className="text-red-500">*</span></label>
              <select
                value={materialId}
            ...
            <div>
              <label className="block text-sm font-medium text-gray-700">Jumlah Pemasukan <span className="text-red-500">*</span></label>
              <input
                type="number"
                value={quantity}
            ...
            <div className="flex justify-end gap-3 pt-4">
              ...
              <button type="submit" disabled={loading} className="px-4 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 disabled:bg-gray-400">
