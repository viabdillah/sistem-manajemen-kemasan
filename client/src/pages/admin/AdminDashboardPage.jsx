...
import { BsPeopleFill, BsPersonPlusFill, BsBoxSeam, BsArrowRight } from 'react-icons/bs';
    ...
    <div className="p-4 md:p-6 animate-fade-in space-y-6">
      ...
      <div className="bg-white p-6 rounded-xl shadow-lg">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-semibold text-gray-800">Pengguna Baru Menunggu Role</h2>
          <Link 
            to="/admin/users"
          ...
          <table className="min-w-full divide-y divide-gray-200">
            <thead className="bg-gray-50">
              <tr>
                ...
                <th className="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase">Tanggal Mendaftar</th>
              </tr>
            </thead>
            <tbody className="bg-white divide-y divide-gray-200">
              {newUsers.length === 0 ? (
                <tr><td colSpan="3" className="px-6 py-4 text-center text-gray-500">Tidak ada pengguna baru.</td></tr>
              ) : (
                newUsers.map((user) => (
