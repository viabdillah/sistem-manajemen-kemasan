...
const FinancialHistoryPage = () => {
  ...
  const chartRef = useRef(null); // <-- useRef sudah diimpor
  ...
  const fetchChartData = useCallback(
    async (start, end) => {
      ...
      try {
        ...
        // (sisa logika format chart tidak berubah)
  ...
  // useMemo summaryData (tidak berubah)
  ...
  // handleSaveSuccess (tidak berubah)
  ...
  // handleDownloadChart (logika tidak berubah)
  ...
  // handleFilterChart (logika tidak berubah)
  const handleFilterChart = () => {
    if (!startDate || !endDate) {
      toast.error(
        "Silakan pilih rentang waktu (Mulai dan Akhir) untuk memfilter chart."
      );
      return;
    }
  ...
  return (
    <div className="p-4 md:p-6 animate-fade-in space-y-6">
      ...
      {/* Ringkasan Status & Chart (tidak berubah) */}
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        <div className="lg:col-span-1 grid grid-cols-1 gap-6">
          <SummaryCard
            title="Total Pemasukan"
            amount={summaryData.pemasukan}
            colorClass="bg-green-100 text-green-800"
          />
          <SummaryCard
            title="Total Pengeluaran"
            amount={summaryData.pengeluaran}
            colorClass="bg-red-100 text-red-800"
          />
          <SummaryCard
            title="Saldo Saat Ini"
            amount={summaryData.saldo}
          ...
          {currentUser?.role_name === "manajer" && (
            <div className="flex flex-col md:flex-row items-center gap-2 w-full md:w-auto">
              ...
              <button
                ...
                className="w-full md:w-auto flex items-center justify-center gap-2 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 text-sm font-semibold"
              >
